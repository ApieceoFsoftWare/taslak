          ...
          <div class="row mb-2">
              ...
              <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                      ...
                      <li class="breadcrumb-item active">İlan Detayları</li>
                  </ol>
              </div>
          </div>
      </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">İlan Detayları</h3>
        ...
        <div class="row">
          <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2" style="display: -webkit-inline-box;"> 
              ...
              <p class="text-muted" style="margin-left: 20px;line-height: 55px"><b>Kategorisi</b>: {{\App\Http\Controllers\Admin\CategoryController::getParentsTree($data->category, $data->category->title)}}</p>
            </div>
            <hr>
            ...
            <hr>
            <div>
              <a class="btn btn-block btn-primary" href="{{route('admin.advertisement.edit', ['id'=>$data->id])}}">Edit</a>
              <a class="btn btn-block btn-danger" href="{{ route('admin.advertisement.destroy', ['id'=>$data->id]) }}" 
          ...
          <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              ...
              <div class="text-muted">
                  <img style="max-width: -webkit-fill-available;" src="{{ Storage::url($data->detail_image) }}">    
              </div>
              <br>
