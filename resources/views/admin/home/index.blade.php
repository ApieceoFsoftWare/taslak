      ...
      <!-- Buraya bir banner resmi bölümü eklenmesi lazım -->
        ...
        <div class="row">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <img style="width: 100%" src="{{ Storage::url($data->banner_image ?? 'Banner image yok!') }}" alt="Banner Resmi">
                </div>
            </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card card-default">
                    <div class="card-header">
                        <h2 class="card-title">
                            <b>Anasayda 600x370 1.Resmi</b>
                        </h2>
                    </div>
                    <div class="card-body">
                        <img style="width: 100%" src="{{ Storage::url($data->sub_banner_img1 ?? 'Banner image yok!') }}" alt="Sub Banner Resmi">
                    </div>
                    <div class="card-body">
                        <div class="callout callout-warning">
                            <h5><b>Ana Başlık 1  :</b>{{ $data->sub_banner_img1_title ?? ''}}</h4>
                            <h5><b>Alt Başlık 1:</b> {{ $data->sub_banner_img1_sub_title ?? '' }}</h5>
                            <h5><b>Buton 1: </b> {{ $data->sub_banner_img1_btn_title ?? '' }}</h5>
            ...
            <div class="col-md-4">
                <div class="card card-default">
                    <div class="card-header">
                        <h2 class="card-title">
                            <b>Anasayda 600x370 2.Resmi</b>
                        </h2>
                    </div>
                    <div class="card-body">
                        <img style="width: 100%" src="{{ Storage::url($data->sub_banner_img2 ?? 'Banner image yok!') }}" alt="Sub Banner Resmi">
                    </div>
                    <div class="card-body">
                        <div class="callout callout-danger">
            ...
            <div class="col-md-4">
                <div class="card card-default">
                    <div class="card-header">
                        <h2 class="card-title">
                            <b>Anasayda 600x370 3.Resmi</b>
                        </h2>
                    </div>
                    <div class="card-body">
                        <img style="width: 100%" src="{{ Storage::url($data->sub_banner_img3 ?? 'Banner image yok!') }}" alt="Sub Banner Resmi">
                    </div>
                    <div class="card-body">
                        <div class="callout callout-info">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-default">
                    <div class="card-body">
                    <a href="{{ route('admin.home.edit',['id'=>$data->id ?? '1'] ) }}" class="btn btn-block btn-outline-warning btn-lg">İçerikleri Değiştir</a>
                    </div>
                </div>
                </div>
            </div>
