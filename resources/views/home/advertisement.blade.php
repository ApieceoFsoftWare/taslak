					...
					<div class="col-lg-8 col-12">
						<div class="blog-single-main">
							<div class="row">
								<div class="col-12">
									<div class="image">
										<img src="{{ Storage::url($advertisement->detail_image) }}" alt="#">
									</div>
									<div class="blog-detail">
										<h2 class="blog-title">{{ $advertisement->title }}</h2>
										<div class="blog-meta">
										...
										<div class="row">
											<div class="col-12">
												<div class="content-tags">
													...
													<ul class="tag-inner">
														@php
														$keywords = explode(',',$advertisement->keywords);
								...
								<div class="col-12">
									<div class="comments">
										<h3 class="comment-title">Yorumlar (3)</h3>
										<!-- Single Comment -->
